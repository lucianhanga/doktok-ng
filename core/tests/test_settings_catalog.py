...
def test_ollama_think_keeps_moe_thinking_on_for_structured() -> None:
    ...
    # dense model honours the chosen density.
    assert ollama_think_for("off", "qwen3:14b", structured=True) is False
    assert ollama_think_for("high", "qwen3:14b", structured=False) is True
